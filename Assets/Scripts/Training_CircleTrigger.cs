...
public class Training_CircleTrigger : MonoBehaviour {
    ...
    public GameObject Controller3DModel;
    ...
    void Start()
    {
        ...
        Controller3DModel = GameObject.Find("Controller3DModel");
        Controller3DModel.SetActive(false);
    }
    ...
    void OnTriggerEnter (Collider c) {
        if (c.gameObject.name == "Controller (right)")
        {
            ...
            ///Instruction text
            touchText.text = "Good job!" + System.Environment.NewLine + "Now go back to start!";
            Controller3DModel.SetActive(true);
