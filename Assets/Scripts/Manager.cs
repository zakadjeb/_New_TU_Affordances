...
public class Manager : MonoBehaviour {
    ...
    void Start () {
        ...
        oW = opening.GetComponent<OpeningWidth>();
        ...
        lO = controller.GetComponent<LightsOn>();
        ...
        for (int i = 0; i < (trials / 2); i++)
        {
            ...
            goNoGoList = tempGoNoGo.OrderBy(x => UnityEngine.Random.value).ToList();
                ...
                //Sending first marker
        sM.marker.Write("Experimental scene entered");
    }
    ...
    void Update() {
        ...
        if (trialNo == trials + 1)
        {
            ...
            exitingTxt.text = trials.ToString() + " trials reached." + System.Environment.NewLine + "Thank you for participating!";
